...
export default function AnecdoteComponent() {
    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-center mt-[5vh] bg-custom-primary h-auto m-0 md:m-8 p-4 md:p-8 rounded-2xl shadow-2xl overflow-hidden">
            <div className="bg-custom-secondary rounded-full flex items-center justify-center aspect-square w-20 md:w-auto md:max-w-[10vw] md:max-h-[15vh] mb-4 md:mb-0 md:mr-4">
